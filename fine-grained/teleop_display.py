...
COMMANDS = {
    "motor_enable": "01 06 01 00 00 01 49 F6",  # Initialize  reg 0x0100=1
    "force_50":     "01 06 01 01 00 32 39 E3",  # Force 50%   reg 0x0101=50
    "clamp_min":    "01 06 01 03 00 00 78 36",  # Fully closed (0‰)   reg 0x0103=0
    "clamp_max":    "01 06 01 03 03 E8 78 88",  # Fully open (1000‰)  reg 0x0103=1000
}
...
class GripperController:
    ...
    def enable(self):
        ...
        time.sleep(3)          # AG gripper needs ~3 s to finish initialization
        self._send("force_50") # Set default operating force
